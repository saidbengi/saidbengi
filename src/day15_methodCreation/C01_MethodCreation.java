...
public class C01_MethodCreation {
    public static void main(String[] args) {
        ...
        // surekli kullanabilecegimiz kod bloklarini hazir olarak koyar
        ...
        // bir islei sadece 1 kere yapacaksak method kullanmamiza gerek olmayabilir
        // ancak ozellikle cok kullanacagimiz islemler icin
        // her seferinde yeniden ayi kodlari yazmak yerine
        // bu islemi yapan hazir bir method olusturmak cok daha pratiktir

        // bazen bir class'in icersinde cok uzun kodlar yazarsak
        // tum class'in anlasilmasi zorlasabilir
        // bunun yerine kod'un belli kisimarini ayri method'lar olarak olusturup
