...
public class C02_Update {
    // Verilen mapteki numarasi 102 olan kaydın bransını  Java yapalim

    /*
    Map'de value compleks olabildigi icin value icerisinden bir bolumu degistirmek istersek
    once value ulsakmak sonra onu
    manipule ederek  istedigimiz degisikligi yapmak
