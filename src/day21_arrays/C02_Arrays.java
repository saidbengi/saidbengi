...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        // array'in icindeki index'i kullanarak elementlere ulasabilir ve uptade edebiliriz

        int arr2[]=new int[4];

        System.out.println(arr2[1]);// 0
        System.out.println(arr2[3]);// 0
       // System.out.println(arr2[5]);// out of bound hatasi

        // Array'in tamamini yazdirmak istersek

        System.out.println(arr2); // [I@58372a00 referans numarasini verir
                                    // array'ler non-primitive olduklarindan direk yazdirmak istersek
