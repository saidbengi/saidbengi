...
public class C03_Remove {
    public static void main(String[] args) {
        ...
        // sayilar.remove(5); // IndexOutOfBoundsException RTE hatasi
        ...
        // int sayi=5;
        // sayilar.remove(sayi); // IndexOutOfBoundsException RTE Hatasi
        ...
        // sayilar.remove(Integer.valueOf("5")); // bu da olur ama gereksiz uzun oldu
